...
function Asset(props) {
    function addItem() {
        props.addItemToCart(
            ...
            [...props.cartItems, { itemId: props.id, itemDes: props.nftInfo.title + props.nftInfo.contractMetadata.name, itemImg: props.nftInfo.media[0].thumbnail }]
            //if it is true, update the array to the old one
            : [...props.cartItems])
            //else if the number of items is 0, add it directly
            : [{ itemId: props.id, itemDes: props.nftInfo.title + props.nftInfo.contractMetadata.name, itemImg: props.nftInfo.media[0].thumbnail }]
        )
